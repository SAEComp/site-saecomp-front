...
const ResultsContainer = () => {
    ...
    const [answers, setAnswers] = useState<GetPublicAnswersOut>({ isLastPage: false, score: 0, evaluations: [] });
    ...
    return (
        <>
            {showCard && <Card evaluationId={selectedEvaluation} setShowCard={setShowCard} />}
            <div
            ...
            >
                ...
                >
                    {answers.evaluations.length ? answers.evaluations.map((evaluation) => (
                        <div
