...
const Questions = ({
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col w-full gap-5 md:gap-10 md:flex-row">
        <QuestionComponent
          ...
          componentProps={{
            ...
            value:
              teachers.find(
                (obj) => obj.id === formState.questions[questionIndex].teacherId
              ) ?? null,
            onChange: (newValue) => {
        ...
        <QuestionComponent
          ...
          componentProps={{
            ...
            value:
              courses.find(
                (obj) => obj.id === formState.questions[questionIndex].subjectId
              ) ?? null,
