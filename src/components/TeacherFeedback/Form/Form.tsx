...
const Form = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-10 w-full bg-[#03B04B] py-8 sm:px-8 md:px-10 px-2">
      <div className="flex flex-col justify-center items-center w-full gap-4 md:flex-row md:gap-[10%]">
      ...
      <div className="flex flex-col gap-4 p-3 w-full md:w-1/2">
        <span className="font-inter text-white">Comentários adicionais</span>
        <TextInput
