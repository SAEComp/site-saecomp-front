        ...
        <div>
            <ContentSection2>
                <Container id = "t1">
                    ...
                    <Text>A transição do <LineThrough>maternal</LineThrough> ensino médio/cursinho para a universidade é algo que assusta muitos calouros, e isso é algo bem comum. No entanto, vocês verão que em pouco tempo estarão acostumados com a vida universitária! O campus de São Carlos é um ambiente agradável e de fácil locomoção. A cidade oferece uma vasta gama de lojas e serviços ao universitário e o pessoal da universidade é amigável e está sempre disposto a auxiliar.  Seja lá quais forem suas dúvidas e preocupações, nós da <b>SAEComp</b> estaremos sempre presentes e prontos para auxiliar em qualquer situação. Este manual busca sanar dúvidas frequentes e fornecer dicas úteis aos calouros do curso através de textos informais e objetivos, evitando uma leitura cansativa ou o bombardeamento de informações, então só vai e leia esse negócio!  Sinta-se orgulhoso por ter entrado na USP e aproveite os melhores anos que você terá na sua vida!</Text>
                    </Defaultmargin>
                </Container>
            ...
            <ContentSection2>
                ...
                <Container id = "t5">
                    ...
                    <Text> Criada em 2016, a <b>Semana da Engenharia de Computação (SEnC)</b> é um evento organizado pelos alunos da USP - São Carlos que visa fortalecer a identidade profissional do engenheiro de computação. A edição de 2025 foi um verdadeiro marco de conexão com o mercado e inovação tecnológica. A grade contou com a presença de gigantes como <b>Samsung</b> e <b>Motorola</b>, trazendo discussões sobre saúde digital e soluções móveis, além de palestras de vanguarda sobre Computação Quântica, IA e Cibersegurança. Para além da teoria, o evento proporcionou experiências práticas imersivas, com destaque para o desafiador <b>Hackathon USP + Digitaly Technology</b> e a incrível <b>Viagem Técnica ao CNPEM</b>. Foi uma semana essencial para quem busca estar na fronteira do conhecimento e expandir seu networking. </Text>
                ...
                <Container id = "t6"> 
                    ...
                    <Text>Como as aulas do nosso curso são ministradas no campus 2, a USP oferece um ônibus gratuito para o transporte dos estudantes entre os campus. <b>Fique atento aos horários, que mudam de tempos em tempos!</b> O tempo de transporte é de aproximadamente 15 minutos. <br></br>Os horários estão no <LinkSocial target= "_blank" href="http://www.puspsc.usp.br/horario-de-onibus-areas-1-e-2/">site do campus</LinkSocial>.</Text>
                    </Defaultmargin> 
                </Container>
